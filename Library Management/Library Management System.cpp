...
void insert (bookPtr &root)
{
    ...
    cout << "ISBN:\t\t\t";
    getline(cin, isb, '\n');
    if(root==NULL)root = new book (titl, aut, pub, yea, isb,NULL);
    else root = new book (titl, aut, pub, yea, isb, root);
}
...
void searchIsbn(bookPtr temp)
{
    ...
    if(temp==NULL) cout<<"The Book doesnot exist";
    cout << "\n";
}
